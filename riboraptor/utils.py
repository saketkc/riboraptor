...
def get_cell_line_or_tissue(row):
    if str(row["cell_line"]).strip() and str(row["cell_line"]).strip() != "nan":
        return "{}-{}-{}".format(
            row["cell_line"], row["study_accession"], row["experiment_accession"]
        )
    if str(row["tissue"]).strip() and str(row["tissue"]).strip() != "nan":
        return "{}-{}-{}".format(
            row["tissue"], row["study_accession"], row["experiment_accession"]
        )
    if str(row["source_name"]).strip() and str(row["source_name"]).strip() != "nan":
        return "{}-{}-{}".format(
            row["source_name"], row["study_accession"], row["experiment_accession"]
        )
...
def get_fragment_enrichment_score(txt_file):
    ...
    if "nan" not in enrichment:
        return (
            float(enrichment.strip("Enrichment: ")),
            float(pval.strip(")").strip("pval: ")),
        )
    else:
        return np.nan, 1
...
re_ribo_config_dir = (
    "/home/cmb-panasas2/skchoudh/github_projects/re-ribo-smk/snakemake/configs"
)
re_ribo_analysis_dir = "/staging/as/skchoudh/re-ribo-analysis/"
riboraptor_annotation_dir = (
    "/home/cmb-panasas2/skchoudh/github_projects/riboraptor/riboraptor/annotation/"
)
...
genome_fasta_map = {
    ...
    "MG1655": "/home/cmb-panasas2/skchoudh/genomes/escherichia_coli_str_k_12_substr_mg1655/fasta/Escherichia_coli_str_k_12_substr_mg1655.ASM584v2.dna.toplevel.fa",
    "BDGP6": "/home/cmb-panasas2/skchoudh/genomes/drosophila_melanogaster_BDGP6/fasta/Drosophila_melanogaster.BDGP6.dna.toplevel.fa",
    "GRCz10": "/home/cmb-panasas2/skchoudh/genomes/GRCz10/fasta/Danio_rerio.GRCz10.dna.toplevel.fa",
...
chrom_sizes_map = {
    ...
    "MG1655": "/home/cmb-panasas2/skchoudh/genomes/escherichia_coli_str_k_12_substr_mg1655/fasta/Escherichia_coli_str_k_12_substr_mg1655.ASM584v2.dna.toplevel.sizes",
    "BDGP6": "/home/cmb-panasas2/skchoudh/genomes/drosophila_melanogaster_BDGP6/fasta/Drosophila_melanogaster.BDGP6.dna.toplevel.sizes",
    "GRCz10": "/home/cmb-panasas2/skchoudh/genomes/GRCz10/fasta/Danio_rerio.GRCz10.dna.toplevel.sizes",
...
star_index_map = {
    ...
    "MG1655": "/home/cmb-panasas2/skchoudh/genomes/escherichia_coli_str_k_12_substr_mg1655/star_annotated",
    "BDGP6": "/home/cmb-panasas2/skchoudh/genomes/drosophila_melanogaster_BDGP6/star_annotated",
    "GRCz10": "/home/cmb-panasas2/skchoudh/genomes/GRCz10/star_annotated",
...
gtf_map = {
    "hg38": "/home/cmb-panasas2/skchoudh/genomes/hg38/annotation/gencode.v25.annotation.gtf",
    "mm10": "/home/cmb-panasas2/skchoudh/genomes/mm10/annotation/gencode.vM11.annotation.gtf",
    "sacCerR64": "/home/cmb-panasas2/skchoudh/genomes/sacCerR64/annotation/Saccharomyces_cerevisiae.R64-1-1.91.gtf",
    "MG1655": "/home/cmb-panasas2/skchoudh/genomes/escherichia_coli_str_k_12_substr_mg1655/annotation/Escherichia_coli_str_k_12_substr_mg1655.ASM584v2.38.gtf",
    "BDGP6": "/home/cmb-panasas2/skchoudh/genomes/drosophila_melanogaster_BDGP6/annotation/Drosophila_melanogaster.BDGP6.91.gtf",
    "GRCz10": "/home/cmb-panasas2/skchoudh/genomes/GRCz10/annotation/Danio_rerio.GRCz10.91.gtf",
...
def copy_sra_data(
    ...
    for taxon_id, df_group in df_grouped:
        ...
        source_loc = (
            srp_source_dir
            + os.path.sep
            + df_group["experiment_accession"].str.cat(
...
def write_config(species, srp):
    ...
    utr5_bed = os.path.join(
        riboraptor_annotation_dir,
        species,
        genome_annotation_map[species],
        "utr5.bed.gz",
    )
    utr3_bed = os.path.join(
        riboraptor_annotation_dir,
        species,
        genome_annotation_map[species],
        "utr3.bed.gz",
    )
    intron_bed = os.path.join(
        riboraptor_annotation_dir,
        species,
        genome_annotation_map[species],
        "intron.bed.gz",
    )
    start_codon_bed = os.path.join(
        riboraptor_annotation_dir,
        species,
        genome_annotation_map[species],
        "start_codon.bed.gz",
    )
    stop_codon_bed = os.path.join(
        riboraptor_annotation_dir,
        species,
        genome_annotation_map[species],
        "stop_codon.bed.gz",
    )
    cds_bed = os.path.join(
        riboraptor_annotation_dir, species, genome_annotation_map[species], "cds.bed.gz"
    )
...
def create_config_file(df):
    ...
    for taxon_id, df_group in df_grouped:
        assert len(df_group["study_accession"].unique()) == 1, "Multiple SRPs found"
        species = taxon_id_map[taxon_id]
        srp = df_group["study_accession"].unique()[0]
        with open(
            os.path.join(re_ribo_config_dir, "{}_{}.py".format(species, srp)), "w"
        ) as fh:
            ...
            print(
                "Wrote {}".format(
                    os.path.join(re_ribo_config_dir, "{}_{}.py".format(species, srp))
                )
            )
